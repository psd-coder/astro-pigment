...
```astro
---
import { Layout } from "@psd-coder/astro-docs-theme/components";
---
<Layout
  title="Page Title"
...
```astro
---
import { TableOfContents } from "@psd-coder/astro-docs-theme/components";
...
```astro
---
import { Button } from "@psd-coder/astro-docs-theme/components";
---
...
```astro
---
import { Icon } from "@psd-coder/astro-docs-theme/components";
---
<Icon name="github" />
...
```astro
---
import { Footer } from "@psd-coder/astro-docs-theme/components";
---
<Footer />
```
...
```astro
---
import { ThemeToggle } from "@psd-coder/astro-docs-theme/components";
---
<ThemeToggle />
```
...
```astro
---
import { InstallPackage } from "@psd-coder/astro-docs-theme/components";
---
...
```astro
---
import { PrevNextNav } from "@psd-coder/astro-docs-theme/components";
---
<PrevNextNav
...
```astro
---
import { PageHeading } from "@psd-coder/astro-docs-theme/components";
---
...
```astro
---
import { CodeEditor } from "@psd-coder/astro-docs-theme/components/playground";
---
...
```astro
---
import { LivePreview } from "@psd-coder/astro-docs-theme/components/playground";
---
<LivePreview />
```
...
```astro
---
import { CodePanels } from "@psd-coder/astro-docs-theme/components/playground/CodePanels";
const items = [
...
```astro
---
import { ResizablePanes, ResizablePane } from "@psd-coder/astro-docs-theme/components/playground";
---
...
```astro
---
import { CollapsiblePane } from "@psd-coder/astro-docs-theme/components/playground";
---
...
```astro
---
import { Tabs, Tab } from "@psd-coder/astro-docs-theme/components/playground";
---
<Tabs value="one">
